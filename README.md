...
AI 기반 사과 수확, 선별, 재고, 시세 예측, 판매 등록, 쇼핑몰 주문 관리를 위한 MVP 프로젝트입니다.

농장 운영자가 대시보드에서 재고와 주문을 확인하고, AI 도우미에게 질문하거나 판매 등록을 요청할 수 있도록 구성했습니다. 고객은 별도 Apple Market 페이지에서 등록된 사과 상품을 확인하고 주문할 수 있습니다.
